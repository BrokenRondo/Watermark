...
-LSB_WatermarkExtract.dll
   -contains the generated component using MWArray API. 
-LSB_WatermarkExtractNative.dll
   -contains the generated component using native API.
-This readme file

. If the target machine does not have the version 9.0.1 of the MATLAB Runtime installed, 
...
LSB_WatermarkExtract_overview.html - HTML overview documentation file for the generated 
                                     component. It contains the requirements for 
                                     accessing the component and for generating arguments 
                                     using the MWArray class hierarchy.

LSB_WatermarkExtract.xml - This file contains the code comments for the 
                                     LSB_WatermarkExtract component classes and methods. 
                                     Using a third party documentation tool, this file 
                                     can be combined with either or both of the previous 
                                     files to generate online documentation for the 
                                     LSB_WatermarkExtract component.
