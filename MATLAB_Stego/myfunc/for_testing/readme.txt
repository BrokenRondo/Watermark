...
myfunc_overview.html - HTML overview documentation file for the generated component. It 
                       contains the requirements for accessing the component and for 
                       generating arguments using the MWArray class hierarchy.

myfunc.xml - This file contains the code comments for the myfunc component classes and 
                       ...
                       online documentation for the myfunc component.
