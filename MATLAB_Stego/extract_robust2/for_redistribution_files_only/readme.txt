...
extract_robust2_overview.html - HTML overview documentation file for the generated 
                                component. It contains the requirements for accessing the 
                                component and for generating arguments using the MWArray 
                                class hierarchy.

extract_robust2.xml - This file contains the code comments for the extract_robust2 
                                ...
                                documentation for the extract_robust2 component.
